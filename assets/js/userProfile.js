document.addEventListener('DOMContentLoaded', () =>{
    ...
    // const onwerLoggedIn = twittUsers.find(user => user.username.toLowerCase() === usernameLoggedIn.toLowerCase());
    ...
    function displayAllTwitts(twitts = existingTwitts){
        if (twitts.length === 0) {
            ...
            console.log("tesedia twitts siap di gunakan");
            ...
            twitts.forEach(twitt => {
                ...
                const onwerTwitt= twittUsers.find(user => user.username.toLowerCase() === twitt.twittUsernameOwner.toLowerCase());
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        <img id="visitProfile-${onwerTwitt.username}" src=${onwerTwitt.avatar} alt="search" srcset=""
                            class="object-cover w-[46px] h-[46px] rounded-full">
                        <div class="pl-2">
                            <div class="flex gap-1">
                                <p class="text-base font-bold inline-block">${onwerTwitt.name} <img src="assets/verify.png"
                ...
                itemTwitt.querySelector(`#visitProfile-${onwerTwitt.username}`).addEventListener('click', function(event){
                    event.preventDefault(); 

                    localStorage.setItem('usernameProfileChosen', `${onwerTwitt.username}`);
                ...
                // make eventlistener for like fitur
